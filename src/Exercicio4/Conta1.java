        ...
        try {
            ...
            if (resposta1<=valor) {
               valor-=resposta1;
                ...
                throw new ContaExecao("Esse valor execede o limite disponivel. Seu limite é de "+getValor());
            }
        }catch (ContaExecao e){
    ...
    public void sacar() throws ContaExecao {
        ...
        if (resposta1 > 0) {
            if (resposta1>getSaldo()){
                throw new ContaExecao("Valor do saque excede o saldo disponível. Seu saldo atual é: "+getSaldo());
            }
            else  {
                saldo -= resposta1;
